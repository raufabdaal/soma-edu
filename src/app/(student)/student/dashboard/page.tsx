              ...
              {studentData?.studyCode && (
                <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 text-slate-600 rounded-full border border-slate-200/40 text-[10px] font-black uppercase tracking-widest">
                  ...
                  <button
                    ...
                    className="ml-1 p-1 hover:bg-slate-200 rounded-md transition-colors group/copy"
                  ...
                  >
                    {copied ? (
                      ...
                      <svg viewBox="0 0 24 24" width="12" height="12" stroke="currentColor" strokeWidth="3" fill="none" className="group-hover/copy:text-indigo-600 transition-colors">
