              ...
              {studentData?.studyCode && (
                <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 text-slate-600 rounded-full border border-slate-200/40 text-[10px] font-black uppercase tracking-widest">
                  ...
                  <button
                    ...
                    className="ml-1 p-1 hover:bg-slate-200 rounded transition-colors text-slate-400 hover:text-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                    aria-label={copied ? "Copied study code" : "Copy study code"}
